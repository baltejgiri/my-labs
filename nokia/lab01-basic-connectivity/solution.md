...
Prompt State:** * **Significance:**
### Question 1.3
What command shows a line-by-line breakdown of the delta changes you applied inside your 
private session before they are pushed live to the production kernel? * **Answer:** ---
## Section 2: Interface Modeling & Status Verification
### Task 2.1: Operational Status Logs
Run your node's interface operational summary command on `SROS-LAB-SW1` and paste the 
output block focusing specifically on `ethernet-1/1` and its logical subinterface. ```text
[PASTE ETH-1/1 SHOW OUTPUT SUMMARY HERE]
